...
size_t mDaeIndex;size_t mOutputFunctionIndex;}NeOutputParameters;typedef enum
...
PmSparsityPattern mDXICR_P;PmSparsityPattern mTDUICR_P;PmSparsityPattern
mMDUY_P;PmSparsityPattern mMDXY_P;PmSparsityPattern mTDUY_P;PmSparsityPattern
mTDXY_P;PmRealVector mY;PmSparsityPattern mDXY_P;PmRealVector mDXY;
PmSparsityPattern mDUY_P;PmRealVector mDUY;PmSparsityPattern mDTY_P;
PmRealVector mDTY;PmIntVector mMODE;PmRealVector mZC;PmRealVector mCACHE_R;
...
PmRealVector mEQ_TOL;PmBoolVector mLV;PmBoolVector mSLV;}NeDsMethodOutput;
...
NE_DS_METHOD_DNF_P,NE_DS_METHOD_DNF,NE_DS_METHOD_DNF_V_X,NE_DS_METHOD_IC,
...
NE_DS_METHOD_SLV,NE_NUM_METHODS}NeDsMethodId;typedef int32_T(*NeDsMethod)(
const NeDynamicSystem*,const NeDynamicSystemInput*,NeDsMethodOutput*);typedef
NeDsMethodOutput*(*NeDsMakeOutputFcn)(const NeDynamicSystem*,PmAllocator*);
typedef void(*NeDsManagementFcn)(NeDynamicSystem*);typedef void(*
NeDsGenerateFcn)(const NeDynamicSystem*,const NeCgParams*,NeCgResults*);
typedef void(*NeDsSetupLoggerFcn)(const NeDynamicSystem*,NeLoggerBuilder*);
typedef NeDynamicSystem*(*NeDsCreateDsFcn)(const NeDynamicSystem*);typedef void
...
mIsOutputSwitchedLinear;NeDsManagementFcn mReleaseReference;NeDsManagementFcn
mGetReference;NeDsMethod mMethods[NE_NUM_METHODS];NeDsMakeOutputFcn mMakeOutput
[NE_NUM_METHODS];NeDsSetupLoggerFcn mSetupLogger;NeEquationData*mEquationData;
...
mInitialAssertRanges;NeRange*mRanges;NeRange*mEquationRanges;NeParameterData*
...
SWL_NONLINEAR,NUM_CARDINALITY}ModeCardinality;typedef struct SscIniterTag
SscIniter;typedef struct GlobalMethodTableTag GlobalMethodTable;typedef union
...
mJ_P;PmRealVector mJ;PmRealVector mFX;PmRealVector mF;PmIntVector mMODE;}
SlcMethodOutput;typedef enum SlcMethodIdTag{SLC_INVALID_METHOD_ID= -1,
SLC_METHOD_M_P,SLC_METHOD_M,SLC_METHOD_J_P,SLC_METHOD_J,SLC_METHOD_FX,
SLC_METHOD_F,SLC_METHOD_MODE,SLC_NUM_METHODS}SlcMethodId;typedef int32_T(*
